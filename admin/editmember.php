<?php 
    ...
    if(isset($_POST['btnSave'])){
        if(!empty($_POST['fullname']) && !empty($_POST['description']) && !empty($_POST['email']) && !empty($_POST['image']) && !empty($_POST['phone']) && !empty($_POST['birthday']) && !empty($_POST['education'])){
            ...
            if(editMember($id, $fullname, $description, $email, $image, $phone, $birthday, $education)){
...
<body?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form action="editMember.php?id=<?=$member['id_member']?>" method="POST">
                <div class="card" style="width: 100%">
                    <div class="card-header">Add Member</div>
                    <div class="card-body">
                        <div class="form-group mb-2">
                            <label for="fullname">Full Name</label>
                            <input type="text" class="form-control" name="fullname" id="fullname" value="<?=$member['fullname']?>">
                        </div>
                        <div class="form-group mb-2">
                            <label for="description">Description</label>
                            <input type="text" class="form-control" name="description" id="description" value="<?=$member['description']?>">
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="file" class="form-control" name="image" id="image" value="<?=$member['image']?>">
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="date" class="form-control" name="birthday" id="birthday" value="<?=$member['birthday']?>">
                        </div>
                        <div class="form-group mb-2">
                            <label for="education">Education</label>
                            <input type="text" class="form-control" name="education" id="education" value="<?=$member['education']?>">
                        </div>
