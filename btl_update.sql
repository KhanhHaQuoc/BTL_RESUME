...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 17, 2022 lúc 06:57 AM
...
INSERT INTO `contact` (`id`, `full_name`, `email`, `messages`) VALUES
(1, 'khanh', 'khanh@gmail.com', 'abc123\r\n'),
(2, 'khanh', 'khanh@gmail.com', 'abcc');
...
INSERT INTO `members` (`id_member`, `fullname`, `description`, `email`, `image`, `phone`, `birthday`, `education`) VALUES
(1, 'Hà Quốc Khánh', 'Human beings are anatomically similar and related to the great apes but are distinguished by a more highly developed brain and a resultant capacity for articulate speech and abstract reasoning. In addition, human beings display a marked erectness of body carriage that frees the hands for use as manipulative members.', 'hqkhanh391999@gmail.com', './image/khanh.jpg', 393238170, '1999-09-03', 'TLU'),
(2, 'Đường Thanh Công Minh', 'A human is a bipedal hominin characterized by having a higher and vertical forehead compared with earlier hominins. The brain volume is about 1,400 cc. The teeth and jaw are smaller and the chin is prominent. Humans are the hominins capable of creating and using complex tools, solving problems by sense and reasoning, using symbols and language, and creating complex social structures. Over time, humans have demonstrated behavioral modernity and advancement.', 'katminh2910@gmail.com', './image/minh.jpg', 369218874, '1999-10-29', 'TLU');
