     ...
     <div class="container-fluid block-5 py-2 bg-white">
            ...
            <div class="container">
                <div class="row text-start d-flex justify-content-center ">
                    ...
                    <div class="col-12 col-sm-4 mt-5 mb-5">
                        <p class="heading-text fw-bold">Add ons</p>
                            <ul>
                ...
                <div class="row text-start d-flex justify-content-center ">
                    ...
                    <div class="col-12 col-sm-4 mt-5 mb-5">
                        <p class="heading-text fw-bold">Pricing</p>
                ...
                <div class="row text-start d-flex justify-content-center ">
                    ...
                    <div class="container">
                      <div class="row d-flex justify-content-center">
                        ...
                        <div class="col">
                        <button type="button" class="btn btn-dark btn-lg mt-5 mb-5">View more</button></div>
                         </div>
                     </div>
                      <div class="row mb-5">
                        <div class="col">
